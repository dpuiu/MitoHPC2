...
export HP_M="freebayes" 	         # SNV caller: mutect2,mutserve,freebayes or varscan
...
export HP_SH="sbatch -J HP_$$.$HP_M --cpus-per-task=$HP_P --nodes=1 --mem=$HP_MM --time=40:00" ;  export HP_SHS="$HP_SH -d singleton"        # SLURM
#export HP_SH="bsub -J HP_$$.$HP_M -n $HP_P -R \"rusage[mem=$HP_MM]\" -W 00:40" ;                  export HP_SHS="$HP_SH -w \"done(HP_$$)\""  # SLURM
