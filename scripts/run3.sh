...
printf "export HP_M1=$HP_M1\n"
printf "export HP_M2=$HP_M2\n"
printf "export HP_M3=$HP_M3\n"
printf "export HP_M=$HP_M\n"
...
printf "\n"
grep -v "^#" $HP_IN | sed "s|^|$HP_SH $HP_SDIR/filter3.sh |"

printf "\n"
printf "$HP_SHS $HP_SDIR/getSummary.sh $HP_ODIR $HP_M1\n"
printf "$HP_SHS $HP_SDIR/getSummary.sh $HP_ODIR $HP_M2\n"
printf "$HP_SHS $HP_SDIR/getSummary.sh $HP_ODIR $HP_M3\n"
printf "\n"

printf "$HP_SHS $HP_SDIR/merge3Vcfs.sh\n"
